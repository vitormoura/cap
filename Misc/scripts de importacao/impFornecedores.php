...
//3:Capturando lista de fornecedores na base antiga:
$rs = mysql_query( "SELECT * FROM fornecedores ORDER BY codforn ASC", $v1 );
...
{
	//preparando a query...
	$novosDados = sprintsql( 'INSERT INTO colaborador ( codColab, codGrupo, pessoa, nome, fantasia, inscFed, inscEst, endereco, cidade, estado, cep ) 
							  VALUES ( %d, %d, %s, %s, %s, %s, %s, %s, %s, %s, %s )',
							$d['codforn'], $d['codtpforn'], $d['pessoa'], $d['razsocial'], $d['fantasia'],
