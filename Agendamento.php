	...
	!empty( $_POST['TXTvenc']) && !empty( $_POST['TXTval']) && !empty( $_POST['LSdoc'])   && !empty( $_POST['RDfiscal']) && !empty($_POST['LSplano']) )
{
	...
	$insertSql  = sprintsql('INSERT INTO documento ( codTp, codNote, codUser, gravacao, loja, fornecedor, numero, emissao, vencimento, valor, contabil, base )
					  VALUES ( %d, %d, %d, %t, %d, %d, %s, %t, %t, %f, %s, %f )',
					   
						$_POST['LSdoc'], $codNote, $user, $dtGravacao, $_POST['LSloja'], $_POST['LSforn'], $_POST['TXTnum'],
						$_POST['TXTemis'], $_POST['TXTvenc'], $_POST['TXTval'], $_POST['RDfiscal'], $_POST['TXTbase']);
...
<textarea name="TEXTobs" id="TEXTobs" cols="15" rows="4"></textarea></div>
    ...
    <tr>
      ...
      <td class="colunaDireita"><input name="TXTnum" type="text" id="TXTnum" maxlength="12" onKeyPress="NextField( 'TXTemis', event );"> 
        </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="colunaDireita"><input name="TXTvenc" type="text" id="TXTvenc" maxlength="10" onKeyPress="mascarar(this, '00-00-0000');"  onFocus="this.select();" onBlur="DataCheck( this );" onKeyDown="NextField('TXTbase', event );" value="<?php echo @$_POST['TXTvenc']; ?>"></td>
    </tr>
    <tr>
      <td align="right" class="colunaEsquerda">Base p/ c&aacute;lculo : </td>
      <td class="colunaDireita"><input name="TXTbase" type="text" id="TXTbase" onKeyPress="return(currencyFormat(this,'.',',', event, 'TXTval' ));" maxlength="10"> 
        <a href="javascript:;" title="Atrav&eacute;s do preenchimento deste campo, &eacute; poss&iacute;vel analizar posteriormente o perfil de descontos deste fornecedor.">[ Info ]</a> </td>
    </tr>
    <tr>
      <td align="right" class="colunaEsquerda"><label for="TXTval">Valor Real : </label></td>
      <td class="colunaDireita"><input name="TXTval" type="text" id="TXTval" onKeyPress="return(currencyFormat(this,'.',',', event, 'TXTdesc' ));" maxlength="10">
    ...
    <tr>
      ...
      <td class="colunaDireita"><input name="TXTdesc" type="text" id="TXTdesc" onKeyPress="return(currencyFormat(this,'.',',', event, 'LSplano' ));" onBlur="apurarDesconto();" maxlength="10">
	  <span id="descDisplay">&nbsp;</span>        </td>
    </tr>
    <tr>
	  ...
	  <a href="javascript:;" title="Informe-se junto ao seu reponsável qual a op&ccedil;&atilde;o indicada dependendo dos produtos/serviços constantes neste documento.">[ Info ]</a> </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" class="colunaEsquerda"></td>
      <td class="colunaDireita"><input type="submit" name="Submit" value="Cadastrar" id="btnSubmit">
&nbsp;|&nbsp;
<input type="reset" name="Reset" value="Limpar" id="btnLimpar"> </td>
    </tr>
    <tr>
      <td align="right" class="colunaEsquerda"></td>
      <td class="colunaDireita">&nbsp;</td>
