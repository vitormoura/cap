...
//Obtendo a lista de fornecedores, lojas e documentos:	
	...
	$users  = 'SELECT codUser, login FROM usuario ORDER BY login ASC';
...
<form action="resultados.php" method="get" target="resultados" style="margin:0;">
  <table width="764" border="0" cellspacing="0">
    ...
    <tr>
	  ...
	  <select name="LSloja" class="Listas" id="LSloja" onKeyPress="NextField('LSforn', event );">
    ...
    <tr>
      ...
      <td class="colunaDireita">
	  <select name="LSforn" class="Listas" id="LSforn" onKeyPress="NextField('LSuser', event );">
    ...
    <tr>
      <td class="colunaEsquerda"><label for="LSuser">Usu&aacute;rio : </label></td>
      <td class="colunaDireita">
	  <select name="LSuser" class="Listas" id="LSuser" onKeyPress="NextField('TXTnum', event );">
        <option value="0">Todos</option>
		<?php
        //Escrevendo os usuarios:
        options( $users );
       ?>
      </select></td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td class="colunaDireita"><input name="TXTve1" type="text" id="TXTve1" maxlength="10" onKeyPress="mascarar(this, '00-00-0000');" onFocus="this.select();" onBlur="DataCheck( this );" onKeyDown="NextField('TXTve2', event );"> 
        a 
        <input name="TXTve2" type="text" id="TXTve2" maxlength="10" onKeyPress="mascarar(this, '00-00-0000');" onFocus="this.select();" onBlur="DataCheck( this );" onKeyDown="NextField('LSplano', event );"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td class="colunaEsquerda">Despesa : </td>
      <td class="colunaDireita">
	  <select name="LSplano" class="Listas" id="LSplano" onKeyPress="NextField('LSdoc', event );">
        <option value="0">Todas</option>
		<?php
