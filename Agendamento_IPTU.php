...
<textarea name="TEXTobs" id="TEXTobs" cols="15" rows="4"><?php echo @$_POST['TEXTobs']; ?></textarea></div>
    <tr>
    ...
    <tr>
      ...
      <td class="colunaDireita"><input name="TXTnum" type="text" id="TXTnum" maxlength="12" onKeyPress="NextField( 'TXTemis', event );" value="<?php echo @$_POST['TXTnum']; ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="colunaDireita"><input name="TXTval" type="text" id="TXTval" onKeyPress="return(currencyFormat(this,'.',',', event, 'TXTdesc' ));" maxlength="10" value="<?php echo @$_POST['TXTval']; ?>"></td>
    </tr>
    <tr>
